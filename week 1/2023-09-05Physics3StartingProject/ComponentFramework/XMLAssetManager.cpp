...
void XMLAssetManager::AddBoxShape(const tinyxml2::XMLElement* child)
{
	if (std::string(child->FirstChildElement("Shape")->FirstChildElement()->Name()) == "Box"){
		float halfSideLength = child->FirstChildElement("Shape")->FirstChildElement("Box")->FloatAttribute("halfSideLength");

		Vec3 centrePos;
		centrePos.x = child->FirstChildElement("Shape")->FirstChildElement("Box")->FloatAttribute("centrePosX");
		centrePos.y = child->FirstChildElement("Shape")->FirstChildElement("Box")->FloatAttribute("centrePosY");
		centrePos.z = child->FirstChildElement("Shape")->FirstChildElement("Box")->FloatAttribute("centrePosZ");

		GEOMETRY::Box box;
		box.set(halfSideLength, centrePos);
